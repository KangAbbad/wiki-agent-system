...
python3 "$plugin_root/scripts/retention.py" "$workspace" --max-bytes 1 >"$test_root/report.json"
...
python3 "$plugin_root/scripts/retention.py" "$workspace" --apply --max-bytes 1 >"$test_root/apply.json"
